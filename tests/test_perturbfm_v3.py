...
from perturbfm.train.trainer import fit_predict_perturbfm_v3


def test_perturbfm_v3_smoke():
    ...
    out = fit_predict_perturbfm_v3(ds, split, hidden_dim=16, lr=1e-2, epochs=2, device="cpu")
